    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="mt-2">Provide us with feedback on our products or services</p>
        </div>

        {/* How do we use your information */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">How do we use your information?</h2>
          <p className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">How do we protect your information?</h2>
          <p className="mb-4">
        ...
        {/* Do we use 'cookies' */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">Do we use 'cookies'?</h2>
          <p className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <p className="mb-4">We have implemented the following:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">California Online Privacy Protection Act</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">You will be notified of any Privacy Policy changes:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
            <li>Via Email</li>
          </ul>
          <p className="mb-4">Can change your personal information:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        {/* COPPA */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">COPPA (Children Online Privacy Protection Act)</h2>
          <p className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">Fair Information Practices</h2>
          <p className="mb-4">
        ...
        {/* CAN SPAM Act */}
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold mb-4">CAN SPAM Act</h2>
          <p className="mb-4">
          ...
          <p className="mb-4">We collect your email address in order to:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <p className="mb-4">To be in accordance with CANSPAM, we agree to the following:</p>
          <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <p>info@petbarn.jo and we will promptly remove you from ALL correspondence.</p>
        </div>
